...
public class OpsSortBase extends OpsTestsBase {
  ...
  public void testFindAllSort() {
		assertIds(repository.findAll(Sort.by("color")), 4, 6, 5, 1, 2, 3);
	}
  ...
  public void testFindByNumberBefore() {
		assertIds(repository.findByNumberBefore(10, Sort.by(Sort.Order.by("color"), new Sort.Order(Sort.Direction.DESC, "hero"))), 4, 1, 2, 3);
	}
  ...
  public void testFindByTextNotContaining() {
		assertIds(repository.findByTextNotContaining("running", Sort.by(Sort.Direction.DESC, "hero")), 1, 2, 4, 6);
	}
  ...
  public void testFindByNameNotIn() {
		assertIds(repository.findByNameNotIn(Collections.singleton("carl"), Sort.by("hero")), 6, 4, 5, 2, 1);
	}

  @Test
	public void testFindByBooolTrue() {
		assertIds(repository.findByBooolTrue(Sort.by("hero")), 3, 2, 1);
	}

  @Test
	public void testFindByBooollFalse() {
		assertIds(repository.findByBooolFalse(Sort.by("hero")), 6, 4, 5);
	}
